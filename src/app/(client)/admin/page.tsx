  ...
  return (
    <div className="flex justify-center items-center flex-col">
      ...
      <div className="w-full flex flex-col p-5 justify-center items-center">
        <h1 className="w-[30%] text-3xl font-bold p-4 text-center ">
          Post A New Blog/Report
        </h1>
        <Form
          onFinish={onFinish}
          className="flex flex-col justify-center w-[70%] items-center border-[1px] border-[#00000076] p-10 rounded-xl shadow-md"
        >
          <Form.Item
            name="title"
            label="Title"
          ...
          >
            <Select mode="multiple">
              ...
              <Select.Option value="Airdrop">Airdrop</Select.Option>
            </Select>
          </Form.Item>
          <Form.Item
            label="Report"
