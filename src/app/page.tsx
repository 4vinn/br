    ...
    <main>
      <AnimatePresence>
        ...
        >
          ...
          <motion.div
            initial={{ opacity: 0.5, scale: 0.7, y: 200 }}
            whileInView={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ duration: 3 }}
            viewport={{ once: true }}
            className="3d absolute ml-[65vw] mt-[10vh] z-10 w-[28rem] h-[28rem]"
          >
            <Earth />
          </motion.div>
        ...
        <div className="blob z-[-100] w-[75vw] h-[100vh] rounded-[999px] absolute bottom-0 left-0 -z-10 blur-3xl bg-opacity-60 bg-gradient-to-r from-blue-300 via-green-100 to-pink-200"></div> */}
          <motion.div className="h-[90vh] w-[90vw] py-[8rem] flex justify-cente pl-[8vw] items-left flex-col text-left">
            <h2
              className={`${font1.className} text-[30px] sm:text-[40px] md:text-[60px] font-bold `}
            >
              We operate at the
            </h2>

            <h2
              className={`${font1.className} text-[30px] sm:text-[50px] md:text-[70px] font-bold -mt-4 `}
            >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className={`${font1.className} flex flex-col items-center bg-black w-[83vw] mx-auto py-20 px-20 rounded-[1.5rem]`}
          >
          ...
          <div className="flex justify-center flex-col items-center text-center py-8">
            <motion.h1
              ...
              transition={{ duration: 0.4 }}
              viewport={{ once: true }}
              className={`${font1.className} text-[60px] mb-[30px] mt-[80px]`}
            >
              OUR VISION
            </motion.h1>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className=" sm:w-[90vw] md:w-[80vw] lg:w-[50vw]"
            >
              <iframe
                // width="960"
                // height="540"
            ...
            <motion.span
              ...
              transition={{ duration: 0.4 }}
              viewport={{ once: true }}
              className="py-[2rem] text-[1.2rem] xs:w-[10vw] md:w-[80vw] lg:w-[60vw]"
            >
              With BlackRabbit, you stay ahead of the market at your very best,
              every day. With us, you drive growth and achieve more. With us,
              you can make informed decisions.
            </motion.span>
          </div>
          {/* --------------------------promise---------------------------- */}
          <div
            className={`${font1.className} flex justify-center flex-col items-center text-center py-8`}
          >
            <motion.div
              initial={{ opacity: 0, scale: 1, y: 200 }}
              whileInView={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.4 }}
              viewport={{ once: true }}
              className="w-[84vw] flex justify-between border-b-[2px]"
            >
                  ...
                  <div className="group h-full py-3 bg-black hover:bg-[#3F7575]  hover:-translate-y-[1rem] rounded-[1rem] transition ease-out duration-300">
                    ...
                    <div className="px-7 mt-6">
                      ...
                      <p className="my-6  text-[#e1e1e1] opacity-[0.7] group-hover:text-[#D0FF5F]  ">
                        ...
                        knowledge. Explore the realm of digital assets with us
                        and master the art of crafting a robust, diversified
                  ...
                  <div className="group h-full py-3  bg-black  hover:bg-[#0053F5]  hover:-translate-y-[1rem] rounded-[1rem] cursor-default transition ease-out duration-300">
                    ...
                    <div className="px-7 mt-6">
                      ...
                      <p className="my-6  text-[#e1e1e1] opacity-[0.7] group-hover:text-[#D7C5AF] ">
                        Identifying excellence is just the beginning. We invest
                        in promising protocols, adopting a patient approach to
                        nurture their potential over time. Our strategy is
                        simple: buy, hold, and let success unfold.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                <div className="relative h-full">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-black hover:border-red-400 hover:scale-[1.07] ease-out duration-300 group rounded-[2rem]">
                    ...
                    <p className="mb-2 text-left text-gray-800 group-hover:text-red-400">
                      ...
                      web3 sectors, with a proven five-year history of
                      empowering investors in leveraging the potential of
                      crypto.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative h-full">
                  ...
                  <div className="relative h-full p-5 bg-white border-2 border-black hover:border-[springgreen] hover:scale-[1.07] ease-out duration-300 group rounded-[2rem]">
                    ...
                    <p className="mb-2 text-left text-gray-800 group-hover:text-green-400">
                      We bring together everything that the most ambitious
                      crypto investors and teams need to make critical
                      decisions. We synthesise the best data and craft insights.
                    </p>
                  </div>
                </div>
              </motion.div>
          ...
          {/* --------------------------sectors---------------------------- */}
          <div className={`${font1.className} w-[84vw] m-auto py-8 `}>
            <motion.div
              initial={{ opacity: 0, scale: 1, y: 200 }}
              whileInView={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.4 }}
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.4 }}
              viewport={{ once: true }}
              className="w-[84vw] flex justify-between items-end border-b-[2px]"
            >
          ...
          {/* --------------------------blogs---------------------------- */}
          <div
            className={`${font1.className} flex justify-center flex-col items-center text-center pb-[4rem]`}
          >
            <motion.div
              initial={{ opacity: 0, scale: 1, y: 200 }}
              whileInView={{ opacity: 1, scale: 1, y: 0 }}
